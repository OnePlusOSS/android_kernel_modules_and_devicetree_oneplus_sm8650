...
void Gyro_select(struct cam_ois_ctrl_t *o_ctrl,OIS_UBYTE Gyro_sel, bool isTeleOisUseMonitor)
{
    ...
    case 0:
        ...
        if(SPI_Mode_check == 0) {
            ...
            F024_Polling(o_ctrl);
            I2C_OIS_8bit_write(o_ctrl,OIS_gyro_adr, 0x76);
            I2C_OIS_8bit_write(o_ctrl,OIS_gyro_dat, 0x02);
            I2C_OIS_8bit_write(o_ctrl,OIS_gyro_adr, 0x45);
            I2C_OIS_8bit_write(o_ctrl,OIS_gyro_dat, 0x5B);
            I2C_OIS_8bit_write(o_ctrl,OIS_gyro_adr, 0x44);
